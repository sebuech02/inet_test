...
public class mario_splash extends MainActivity{
    public Button start_game;
    private TextView beschreibung;
    @RequiresApi(api = Build.VERSION_CODES.N)
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mario_splash);
        beschreibung = (TextView) findViewById(R.id.dummyid3);
        start_game = (Button) findViewById(R.id.game_start3);
        StringBuilder build = new StringBuilder();
        build.append("SUPER WIECKLAß"+System.lineSeparator());
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.game_start3:
                Toast.makeText(this, "Lade Assets ...", Toast.LENGTH_LONG).show();
                startActivity(new Intent(mario_splash.this, mario_main1.class));
                break;
            default:
                break;
        }
