...
public class k_bonus extends MainActivity implements View.OnClickListener {
    LinearLayout parent;
    Button b1;
    Button sort;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (spiel current : ubergabe) {
            if (current.kategorie.equals("bonus")) {
                btn_name[j] = current.name;
                b1 = new Button(k_bonus.this);
                b1.setId(j + 1);
    ...
    public void onClick(View v) {
        ...
        if(!(str.equals("null"))) {
            Intent actvar = new Intent(k_bonus.this, anzeige.class);
